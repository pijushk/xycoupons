    ...
    @if(isset($data['merchantData']))
        <section>
            <div class="container">
                <ol class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">{{ $data['merchantData']['merchantName'] }}</li>
                </ol>
            </div>
            <!-- //breadcrumb  -->
            <div class="container storeWrap">
                <div class="col-md-3 col-sm-4 storeL"><img src="{{ $data['merchantData']['merchantLogo'] }}"
                                                           class="img-responsive"
                                                           alt="{{ $data['merchantData']['merchantName'] }}"/>
                    <div class="pull-left rating"><a href="#"><i class="fa fa-star"></i></a> <a href="#"><i
                                    class="fa fa-star"></i></a> <a href="#"><i class="fa fa-star"></i></a> <a
                                href="#"><i
                                    class="fa fa-star"></i></a> <a href="#"><i class="fa fa-star-o"></i></a> 4.5 out of
                        5
                    </div>
                    <div class="clearfix"></div>
                    <a class="btn btn-block btn-warning btn-lg text-uppercase">Shop
                        at {{ $data['merchantData']['merchantName'] }}</a>
                    <div class="clearfix"></div>
                    <br>
                    <div class="thumbnail">
                        ...
                        <div class="cclue-filter-cont">
                            <div class="checkbox">
                                <label>
                                    ...
                                    <span class="cr"><i class=" cr-icon fa fa-circle"></i></span> Fashion (13)</label>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="">
                                    <span class="cr"><i class=" cr-icon fa fa-circle"></i></span> Sports & Fitness
                                    (3)</label>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="">
                                    <span class="cr"><i class=" cr-icon fa fa-circle"></i></span> Flowers, Gifts & ...
                                    (2)</label>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="">
                                    <span class="cr"><i class=" cr-icon fa fa-circle"></i></span> Automotive (1)</label>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="">
                                    <span class="cr"><i class=" cr-icon fa fa-circle"></i></span> Miscellaneous
                                    (1)</label>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="">
                                    <span class="cr"><i class=" cr-icon fa fa-circle"></i></span> Kids, Babies & Toys
                                    (2)</label>
                            </div>
                        </div>
                    </div>
            ...
            <button type="submit"> <i class="fa fa-search"></i> </button>
                        ...
                        <div class="cclue-filter-cont">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="">
                                    <span class="cr"><i class=" cr-icon fa fa-circle"></i></span> Samsung</label>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="">
                                    <span class="cr"><i class=" cr-icon fa fa-circle"></i></span> Micromax</label>
                            </div>
                        </div>
                    </div>
                    <!-- //Filter By Brand  -->
                    ...
                    <div class="center-block"><img src="images/amazon-hpromo02122016.jpg" width="100%" height="100%"
                                                   alt=""/></div>
                    <!-- //Add Banner  -->
                ...
                <div class="col-md-9 col-sm-8">
                    <h2><span>{{ $data['merchantData']['merchantName'] }}</span> PROMO CODES & COUPONS
                        ({{ $data['merchantData']['merchantCouponCount'] }})</h2>
                    <!-- //dynamic_text  -->
                    <div class="widget-body">
                        <div class="widget">
                            <ul class="nav responsive-tabs list-inline">
                                <li class="active"><a class="cclue-coupon-filter" data-ctype="all"><i
                                                ...
                                                class="badge badge-info">{{ $data['merchantData']['couponData']['count']['dls'] + $data['merchantData']['couponData']['count']['cpn'] }}</span>
                                    </a></li>
                                <li class=""><a class="cclue-coupon-filter" data-ctype="cpn"><i
                                                class="fa fa-scissors"></i>
                                        Coupons <span class="badge badge-danger">{{ $data['merchantData']['couponData']['count']['cpn'] }}</span></a></li>
                                <li class=""><a class="cclue-coupon-filter" data-ctype="dl"><i
                                                class="fa fa-paperclip"></i>Deals
                                        <span class="badge badge-danger">{{ $data['merchantData']['couponData']['count']['dls'] }}</span></a></li>
                            </ul>
                        </div>
                    </div>
                    @if(isset($data['merchantData']['couponData']['coupon']))
                        @foreach($data['merchantData']['couponData']['coupon'] as $coupon)
                            <div class="bg-danger bg-hover">
                                <div class="ofrpctg">
                                    <div class="thumbnail">
                                        <div class="pctgcell">80% OFF</div>
                                        <div class="nw-offtype"> DEAL</div>
                                    </div>
                                </div>
                    ...
                    <div class="dynamic_text">
                        {!! $data['merchantData']['merchantDesc'] !!}
                    </div>
                        ...
                        <ul class="owl-carousel02">
                            <li class="recent-offers-ctr">
                                <div class="center-block">
                                    ...
                                    <div class="thumbnail"><img src="images/logo-stroe/1168.jpg" width="200"
                                                                height="100"
                                                                alt=""/></div>
                            ...
                            <li class="recent-offers-ctr">
                                <div class="center-block">
                                    ...
                                    <div class="thumbnail"><img src="images/logo-stroe/Abof-Logo-110x50.png" width="110"
                                                                height="50" alt=""/></div>
                            ...
                            <li class="recent-offers-ctr">
                                <div class="center-block">
                                    <h5><i class="fa fa-clock-o"></i> Used 3 mins ago</h5>
                                    <div class="thumbnail"><img src="images/logo-stroe/45.jpg" width="200" height="100"
                                                                alt=""/></div>
                            ...
                            <li class="recent-offers-ctr">
                                <div class="center-block">
                                    ...
                                    <div class="thumbnail"><img src="images/logo-stroe/amazon-coupons-110x50.jpg"
                            ...
                            <li class="recent-offers-ctr">
                                <div class="center-block">
                                    ...
                                    <div class="thumbnail"><img src="images/logo-stroe/ebay.com_coupons_promo_codes.jpg"
                            ...
                            <li class="recent-offers-ctr">
                                <div class="center-block">
                                    ...
                                    <div class="thumbnail"><img src="images/logo-stroe/jabong-coupons_logo_4.png"
                            ...
                            <li class="recent-offers-ctr">
                                <div class="center-block">
                                    ...
                                    <div class="thumbnail"><img src="images/logo-stroe/111.jpg" width="200" height="100"
                                                                alt=""/></div>
